...
import { Button, InputErrorMessage, InputLabel, Modal, NumericInput, TokenAmountDisplay, Tooltip, TooltipInfoIcon } from '@dao-dao/stateless'
        ...
        <Modal
            ...
            footerContent={
                !shitstrapInfo ? undefined : showingDistribute ? (
                    ...
                    <Tooltip
                        title={t('info.distributeToDaoMembersFromWallet')}
                    >
                        <Button
            ...
            header={{
                ...
                title: shitstrapInfo ? shitstrapInfo.title : t('title.rewardDistribution'),
