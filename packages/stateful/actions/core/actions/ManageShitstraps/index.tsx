...
import { cwShitstrapExtraQueries, cwShitstrapFactoriesExtraQuery, tokenQueries } from "@dao-dao/state/query"
import {
  ActionBase,
  AddressInput,
  Loader,
...
const DaoComponent: ActionComponent<undefined, ManageShitStrapData> = (
  ...
  const widgetData = useWidget<ShitstrapPaymentWidgetData>(WidgetId.ShitStrap)
    ?.daoWidget.values
