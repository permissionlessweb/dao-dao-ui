import { ActionComponent, ActionContextType, GenericTokenBalanceWithOwner, LoadingDataWithError } from "@dao-dao/types"
import { ShitstrapPaymentWidgetData } from "../../../../widgets/widgets/Shitstrap/types"
import { useFormContext } from "react-hook-form"
import { useWallet } from "../../../../hooks"
import { useTranslation } from "react-i18next"
import { AddressInput, Button, ChainProvider, DaoSupportedChainPickerInput, FormSwitch, InputErrorMessage, InputLabel, ShitstrapPicker, useActionOptions, useDao, ValidatorPicker } from "@dao-dao/stateless"
import { getChainAddressForActionOptions, getChainForChainId, makeCombineQueryResultsIntoLoadingDataWithError, makeValidateAddress, processError, validateRequired } from "@dao-dao/utils"
import { ArrayOfShitstrapContract } from "@dao-dao/types/contracts/ShitstrapFactory"
import { useEffect, useState } from "react"
import { QueryClient, useQueries } from "@tanstack/react-query"
import { useRecoilCallback } from "recoil"
import { cwShitstrapExtraQueries, cwShitstrapFactoriesExtraQuery, shitStrapQueries } from "@dao-dao/state/query"
...
export type ShitstrapOverFlowData = {
  chainId: string
...
export const RedeemShitstrapOverflow: ActionComponent<
  RedeemShitstrapOverflowOptions
> = ({
  fieldNamePrefix,
  errors,
  isCreating,
        ...
        <div className="flex flex-row flex-wrap items-center gap-2">
          <div className="flex shrink-0 flex-col gap-1">
            <div className="flex flex-row items-end justify-between gap-2">
              <InputLabel name={t('form.inputShitstrapOverflow')} />
            </div>
