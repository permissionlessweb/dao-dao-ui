...
> = ({ ...props }) => {
  ...
  const watchInfusionId = watch(
    (props.fieldNamePrefix + 'infuse.infusionId') as 'infuse.infusionId'
  )
    ...
    if (mode === 'create') {
      ...
      const createInfusionMsg = makeExecuteSmartContractMessage({
        ...
        funds: create.deposit
          .map(({ denom, amount }) => HugeDecimal.from(amount).toCoin(denom))
    ...
    if (isNativeCreate) {
      return {
        ...
        create: {
          ...
          collections:
            decodedMessage.wasm.execute.msg.create_infusion.collections,
          infusedCollection:
            decodedMessage.wasm.execute.msg.create_infusion.infused_collection,
          infusionParams:
            decodedMessage.wasm.execute.msg.create_infusion.infusion_params,
          paymentRecipient:
            decodedMessage.wasm.execute.msg.create_infusion.payment_recipient,
          deposit: decodedMessage.wasm.execute.funds,
          description:
            decodedMessage.wasm.execute.msg.create_infusion.description,
          mode: decodedMessage.wasm.execute.msg.create_infusion.infusion_params
            .bundle_type,
        },
      }
