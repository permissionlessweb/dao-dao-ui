              ...
              <div className="flex flex-col gap-3">
                ...
                {eligibleCollectionField.map((props, index) => {
                  return (
                    <div
                      key={props.id}
                      className={`flex rounded-lg p-3 flex-row flex-wrap items-center gap-2 ${
                        index % 2 === 0
                      ...
                      <div className="flex shrink-0 flex-col gap-1">
                        <div className="flex flex-row gap-1">
                          ...
                          <div className="flex flex-col gap-4">
                            <InputLabel
                              name={t(
                                'form.infusedEligibleCollectionMaxRequired'
                              )}
                            />
                            <NumericInput
                              disabled={!isCreating}
                              ...
                              fieldName={
                                (fieldNamePrefix +
                                  `collections.${index}.max_req`) as `collections.${number}.max_req`
                              }
                              getValues={getValues}
                              max={25}
                              register={register}
                          ...
                          <div className="flex flex-col gap-4">
                            ...
                            <TokenInput
                              ...
                              selectedToken={{
                                ...
                                denomOrAddress:
                                  watchInfusedParams.mint_fee?.denom!,
                                chainId: watchChainId,
                              }}
                              showChainImage
                              tokens={{
