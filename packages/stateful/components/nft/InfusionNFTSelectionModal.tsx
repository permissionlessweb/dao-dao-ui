...
import { InfusionsEligibleCollection } from '@dao-dao/types/contracts/CwInfuser'

type LazyNftCardWithLoadedInfo = LazyNftCardInfo & {
  loadedInfo?: NftCardInfo
}
type EligibleNftSelectionModal = NftSelectionModalProps & {
  eligible?: InfusionsEligibleCollection
}

const NFTS_PER_PAGE = 30

export const InfusionNFTSelectionModal = ({
  nfts,
  selectedKeys,
  onNftClick,
  onSelectAll,
